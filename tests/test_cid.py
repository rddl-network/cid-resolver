...
def test_post_cid_unauth():
    response = client.post(
        f"/entry/?cid=bafkreibklq6s67jlcni2alpkqmxuyz4kh65uefp6vltoglnrr6riezs4qi&url=%20https%3A%2F%2Fbafkreibklq6s67jlcni2alpkqmxuyz4kh65uefp6vltoglnrr6riezs4qi.ipfs.w3s.link"
    )
